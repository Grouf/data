...
function get_sets()
	...
	sets.precast.Ranged= {head="Uk'uxkaj Cap",neck="Arctier's Torque",left_ear="Clearview earring",
		...
		legs="Thur. Tights +1",feet="Pillager's Poulaines"} --need to verify
	
	sets.precast.WS= {ammo="Qirmiz Tathlum",head="Uk'uxkaj Cap",neck="Tlamiztli Collar",left_ear="Steelflash Earring",
	...
	sets.precast["Blade Kamu"] = set_combine(sets.precast.WS,{right_ring="Flame Ring"})<!--STR50 INT50-->
	
	sets.precast["Blade Jin"] = sets.precast.WS --STR30 DEX30
	
	sets.precast["Blade Yu"] = set_combine(sets.precast.WS,{neck="Breeze Gorget",left_ear="Friomisi Earring",
		right_ear="Novio Earring",back="Toro Cape",waist="Breeze Belt",} --DEX50 INT50
	
	sets.precast.Utsusemi= {head="Athos's Chapeau",neck="Magoraga Beads",left_ear="Phawaylla Earring",
		right_ear="Loquac. Earring",body="Otronif Harness",hands="Kog. Tekko +2",left_ring="",
		right_ring="",back="Yokaze Mantle",waist="Phasmida Belt",
		legs="Otronif Brais",feet="Iga Kyahan +2"}
	...
	sets.precast.Enfeeble= {head="Hachiya Hatsuburi",neck="Stoicheion Medal",left_ear="Lifestorm Earring",
		right_ear="Psystorm Earring",body="Otronif Harness",hands="Kog. Tekko +2",left_ring="",
		right_ring="Omega Ring",back="Yokaze Mantle",waist="Phasmida Belt",
		legs="Otronif Brais",feet="Hachiya Kayahan"}  --needs verify
	
	sets.precast.Nuke= {head="Koga Hatsuburi",neck="Stoicheion Medal",left_ear="Friomisi Earring",
		right_ear="Hecate's Earring",body="Otronif Harness",hands="Kog. Tekko +2",left_ring="Icesoul Ring",
		right_ring="",back="Toro Cape",waist="Koga Sarashi",
		legs="Shneddick Tights",feet="Hachiya Kayahan"}
	
	sets.precast.Step = {head="Ejekamal Mask",neck="Asperity Necklace",left_ear="Steelflash Earring",
		right_ear="Heartseeker Earring",body="Manibozho Jerkin",hands="",left_ring="Rajas Ring",
		right_ring="Epona's Ring",back="",waist="Phasmida Belt",
		legs="Manibozho Brais",feet=""}--Needs Verify
	
		
	sets.TP = {}
	sets.TP.DD = {ammo="Qirmiz Tathlum",head="Otronif Mask",neck="Asperity Necklace",left_ear="Steelflash Earring",
	...
	sets.TP.EVA = set_combine(sets.TP.DD,{head="Uk'uxkaj Cap",neck="Torero Torque",left_ear="Ethereal Earring",
	...
	sets.TP.DT= {ammo="Demonry Stone",head="Uk'uxkaj Cap",neck="Twilight Torque",left_ear="Dudgeon Earring",
...
function precast(spell)
	...
	elseif spell.type == "Ninjitsu" then
		if NinjitsuNuke[spell.english] then
			equip(sets.precast.Nuke)
		elseif NinjitsuEnfeeble[spell.english] then
